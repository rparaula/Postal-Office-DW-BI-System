...
CREATE TABLE `package_movement_event_type` (
  ...
  CONSTRAINT `chk_package_movement_event_type_flags` CHECK (((`is_entry_event` in (0,1)) and (`is_exit_event` in (0,1)) and (`is_processing_event` in (0,1)) and (`is_final_event` in (0,1)) and (`is_active` in (0,1)))),
...
-- Dump completed on 2026-06-21 14:45:17
