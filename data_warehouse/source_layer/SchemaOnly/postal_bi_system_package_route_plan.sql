...
CREATE TABLE `package_route_plan` (
  ...
  CONSTRAINT `chk_package_route_plan_distinct_facilities` CHECK ((`planned_origin_facility_id` <> `planned_destination_facility_id`))
...
-- Dump completed on 2026-06-21 14:45:37
