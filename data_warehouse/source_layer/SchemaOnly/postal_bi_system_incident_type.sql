...
CREATE TABLE `incident_type` (
  ...
  `blocks_package_movement` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`incident_type_id`),
  UNIQUE KEY `uq_incident_type_name` (`type_name`),
  CONSTRAINT `chk_incident_type_blocks_package_movement` CHECK ((`blocks_package_movement` in (0,1)))
...
-- Dump completed on 2026-06-21 14:45:36
