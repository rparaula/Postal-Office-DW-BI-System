...
CREATE TABLE `package_status` (
  ...
  `allowed_service_type_id` int DEFAULT NULL,
  PRIMARY KEY (`package_status_id`),
  UNIQUE KEY `uq_package_status_name` (`status_name`),
  KEY `idx_package_status_allowed_service_type_id` (`allowed_service_type_id`),
  CONSTRAINT `fk_package_status_allowed_service_type` FOREIGN KEY (`allowed_service_type_id`) REFERENCES `service_type` (`service_type_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- Dump completed on 2026-06-21 14:45:44
